...
public class DecoratedEllipStrategy implements IDrawShapeStrategy {
    @Override
    ...
    public void outlined(myPoint newp1, myPoint newp2, Graphics2D graphics2D, Color primarycolor) {
        ...
        if (newp1.getX() < newp2.getX() && newp1.getY() < newp2.getY()) {  //top left -> bottom right
            graphics2D.drawOval(newp1.getX()-10, newp1.getY()-10, Math.abs(newp1.getX() - newp2.getX())+20, Math.abs(newp2.getY() - newp1.getY())+20);
        }
        if (newp1.getX() < newp2.getX() && newp1.getY() > newp2.getY()) {  //bottom left -> top right
            graphics2D.drawOval(newp1.getX()-10, newp2.getY()-10, Math.abs(newp1.getX() - newp2.getX())+20, Math.abs(newp2.getY() - newp1.getY())+20);
        }
        if (newp1.getX() > newp2.getX() && newp1.getY() < newp2.getY()) {  //top right -> bottom left
            graphics2D.drawOval(newp2.getX()-10, newp1.getY()-10, Math.abs(newp1.getX() - newp2.getX())+20, Math.abs(newp2.getY() - newp1.getY())+20);
        }
        if (newp1.getX() > newp2.getX() && newp1.getY() > newp2.getY()) {  //bottom right -> top left
            graphics2D.drawOval(newp2.getX()-10, newp2.getY()-10, Math.abs(newp1.getX() - newp2.getX())+20, Math.abs(newp2.getY() - newp1.getY())+20);
        }
    }
